...
A Fabric mod for Minecraft 26.1.2 that runs the complete male fruit fly nervous system inside a fly mob.
...
Requirements: Minecraft 26.1.2, Fabric Loader 0.19.3 or newer, Fabric API 0.155.0+26.1.2, Java 25 or newer. A machine with
